...
<form id="registerForm" action="Register" method="POST" enctype="multipart/form-data">
    ...
    <div class="w3-row-padding">
        ...
        <div class="w3-half">
            <h4 class="w3-text-theme">Account Details</h4>
            <div>
        ...
        <div class="w3-half">
            <h4 class="w3-text-theme">Personal Info</h4>
            <div>
            ...
            <div>
                <label class="w3-text-theme">Gender <span style="font-size:0.85em;color:#999">(optional)</span></label>
